/*
  This is the initial ios app extension view controller, which is referenced by DankKnob-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class DankKnobViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in DankKnob-iOS-MainInterface.storyboard to custom class: GenericUI  module: DankKnobFramework
