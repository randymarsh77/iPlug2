...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DankKnob Demo Installer\n"
      else:
        line="OutputBaseFilename=DankKnob Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DankKnob Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DankKnob installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DankKnob Demo installer\n"
     else:
       line="SetupWindowTitle=DankKnob installer\n"
