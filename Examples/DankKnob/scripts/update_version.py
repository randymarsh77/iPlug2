...
def main():
  ...
  plistpath = scriptpath + "/resources/DankKnob-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DankKnob-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DankKnob-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DankKnob-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DankKnob-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DankKnob.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DankKnob.iss",inplace=1):
